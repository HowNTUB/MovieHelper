...
def handle_postback(event):
    ...
    infoContant, actorContant, stillsContant = use_movieurl_get_movieinfo(event.postback.data)
    line_bot_api.reply_message(event.reply_token,[infoContant, actorContant, stillsContant])
