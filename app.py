...
def handle_postback(event):
    ...
    moviePosterContant, infoContant, storyContant, actorContant, stillsContant, articleContents = use_movieurl_get_movieinfo(
        event.postback.data)
    line_bot_api.reply_message(
        event.reply_token, [moviePosterContant, infoContant, storyContant, actorContant, stillsContant, articleContents])
